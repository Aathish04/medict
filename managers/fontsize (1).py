...
fontSize = 12
layout = [[sg.Spin([sz for sz in range(12, 21)], font=('Helvetica 20'), initial_value=fontSize, change_submits=True, key='spin'),
           sg.Slider(range=(12,21), orientation='h', size=(10,20),
           key='slider', font=('Helvetica 20')),
